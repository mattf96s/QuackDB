...
export default function Toolbar() {
	...
	return (
		<Menubar className="rounded-none border-none bg-inherit p-0 shadow-none">
			<MenubarMenu>
				<div className="inline-flex h-8 items-center overflow-hidden rounded-xs bg-[#30a46c] text-white shadow-sm">
					<button
						type="button"
						onClick={onRun}
						className="inline-flex h-8 items-center justify-center whitespace-nowrap px-3 text-xs font-semibold transition-colors hover:bg-[#2b9a66] focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
					>
