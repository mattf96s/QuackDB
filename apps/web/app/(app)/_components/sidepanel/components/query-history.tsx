...
export default function QueryHistory() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: TODO: investigate why i needed this in the first place
  useEffect(() => {
    let ignore = false;
  ...
  return (
    <div className="flex flex-col pt-2">
      ...
      <motion.div
        ...
        // biome-ignore lint/a11y/useSemanticElements: TODO: change to semantically correct tags
        role="list"
      >
        {runs.map((run) => {
